...
public class DebugWidget : MonoBehaviour
{
	...
	[Conditional("UNITY_EDITOR")]
	public static void Move(GameObject srcGO, Vector3 pos, Quaternion rot, emotitron.NST.DebugXform istype, emotitron.NST.DebugXform iftype, bool moveThis = true)
	{
		if (!moveThis)
			return;
