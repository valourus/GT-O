...
namespace emotitron.NST
{
	...
	public class NSTMaster : Singleton<NSTMaster>
	{
		...
		private void Update()
		{
			...
			/// Send in Update version
			//// Test for Network Tick being due
			//// TODO: send multiple if more than one is due?
			...
			//		////TEST
			//		//ontickSendsDue = 0;
			//		offtickSendDue = false;
			//	}
			//	else if (offtickSendDue)
			//	{
		...
		public static int FrameCounter
		{
			...
			private set { _frameCounter = (value > 59) ? value - 60 :  (value < 0) ? value + 60 : value; }
		}
