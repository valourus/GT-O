		...
		public static string WorldBoundsSummary()
		{
			...
			for (BitCullingLevel bcl = 0; bcl < BitCullingLevel.DropAll; bcl++ )
				str += "\n\n" +
					...
					"x: " + WorldVectorCompression.axisRanges[0].GetBitsAtCullLevel(bcl) + " bits, " +
					"y: " + WorldVectorCompression.axisRanges[1].GetBitsAtCullLevel(bcl) + " bits, " +
					"z: " + WorldVectorCompression.axisRanges[2].GetBitsAtCullLevel(bcl) + " bits, ";
