...
namespace emotitron.NST
{
	...
	public class HitGroupSettings : SettingsScriptableObject<HitGroupSettings>
	{
		...
		public override bool DrawGui(object target, bool asFoldout, bool includeScriptField = true)
		{
			expandeds[target] = base.DrawGui(target, asFoldout, includeScriptField);
	...
	public class HitGroupSettingsEditor : SettingsSOBaseEditor<HitGroupSettings>
	{
		...
		{
			base.OnInspectorGUI();
			HitGroupSettings.Single.DrawGui(target, false, true);
		}
	}
#endif
}
